...
const Icon24BianjiqiYangshi3: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
Icon24BianjiqiYangshi3.defaultProps = {
  size: 18,
};

export default Icon24BianjiqiYangshi3;
