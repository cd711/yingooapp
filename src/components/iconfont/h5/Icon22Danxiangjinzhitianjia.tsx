...
const Icon22Danxiangjinzhitianjia: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
Icon22Danxiangjinzhitianjia.defaultProps = {
  size: 18,
};

export default Icon22Danxiangjinzhitianjia;
