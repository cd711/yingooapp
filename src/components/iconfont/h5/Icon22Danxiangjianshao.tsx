...
const Icon22Danxiangjianshao: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
Icon22Danxiangjianshao.defaultProps = {
  size: 18,
};

export default Icon22Danxiangjianshao;
